# 10 — Chat pill + modal dialog

**Legacy:** was #20 in the love-letter effort.
...
**Blocked by:** love-letter-i18n/01 (chat strings go through the dictionary)
...
**Decisions (grilling session 2025):** Q2 two separate elements (this ticket) vs the log strip (love-letter-story/01). Q12 pill with inline preview + badge. Q13 badge only, cleared on open. Q14 modal (not popover/sheet). Q15 single column, keep 1080px. The pill replaces the sidebar on desktop and the static block on mobile.
