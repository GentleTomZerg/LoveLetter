# 3 — Art integration (user-provided PNGs)

**Legacy:** was #8 in the love-letter effort.
...
**Blocked by:** 1 (the card/table UI it enhances)
...
Integrated ahead of the original ticket schedule at the user's request (love-letter-engine/03 wrap-up). Rank 2 artwork is captioned "Spy" in its source filename — the game displays "Priest" (2012 original name); regenerate that image if the art itself depicts a spy. The "courtess" filename typo is irrelevant (rank-keyed names).
