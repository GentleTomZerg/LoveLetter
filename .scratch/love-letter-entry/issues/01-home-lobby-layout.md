...
- [x] Home: **Join a table** card — an empty-directory slot (renders ticket 2's list when it lands; empty state "No open tables — start one!"), plus a collapsed *"I have a code?"* field for join-by-code
